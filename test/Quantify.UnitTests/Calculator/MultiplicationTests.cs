...
namespace Quantify.UnitTests.Calculator
{
    ...
    public class MultiplicationTests
    {
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Decimal_Multiplier_Short_THEN_ReturnProduct(string multiplicandString, string multiplierString)
        {
            // Arrange
        ...
        [DataRow("-32.9284", "88")]
        [DataRow("-26.456", "0")]
        public void WHEN_Multiplying_WHILE_Multiplicand_Decimal_Multiplier_UnsignedShort_THEN_ReturnProduct(string multiplicandString, string multiplierString)
        {
            // Arrange
            var valueCalculator = new DecimalValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Decimal_Multiplier_Integer_THEN_ReturnProduct(string multiplicandString, int multiplier)
        {
            // Arrange
            var valueCalculator = new DecimalValueCalculator();
        ...
        [DataRow("-26.456", 0U)]
        public void WHEN_Multiplying_WHILE_Multiplicand_Decimal_Multiplier_UnsignedInteger_THEN_ReturnProduct(string multiplicandString, uint multiplier)
        {
            // Arrange
            var valueCalculator = new DecimalValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Decimal_Multiplier_Long_THEN_ReturnProduct(string multiplicandString, long multiplier)
        {
            // Arrange
            var valueCalculator = new DecimalValueCalculator();
        ...
        [DataRow("-26.456", 0UL)]
        public void WHEN_Multiplying_WHILE_Multiplicand_Decimal_Multiplier_UnsignedLong_THEN_ReturnProduct(string multiplicandString, ulong multiplier)
        {
            // Arrange
            var valueCalculator = new DecimalValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Decimal_Multiplier_Double_THEN_ReturnProduct(string multiplicandString, double multiplier)
        {
            // Arrange
            var valueCalculator = new DecimalValueCalculator();
        ...
        [DataRow("-26.456", "0")]
        [DataRow("-11.112", "-2.365444")]
        public void WHEN_Multiplying_WHILE_Multiplicand_Decimal_Multiplier_Decimal_THEN_ReturnProduct(string multiplicandString, string multiplierString)
        {
            // Arrange
            var valueCalculator = new DecimalValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Decimal_Multiplier_Float_THEN_ReturnProduct(string multiplicandString, float multiplier)
        {
            // Arrange
            var valueCalculator = new DecimalValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Double_Multiplier_Short_THEN_ReturnProduct(double multiplicand, string multiplierString)
        {
            // Arrange
        ...
        [DataRow(double.MinValue, "9")]
        [DataRow(double.MinValue, "0")]
        public void WHEN_Multiplying_WHILE_Multiplicand_Double_Multiplier_UnsignedShort_THEN_ReturnProduct(double multiplicand, string multiplierString)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Double_Multiplier_Integer_THEN_ReturnProduct(double multiplicand, int multiplier)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Double_Multiplier_UnsignedInteger_THEN_ReturnProduct(double multiplicand, uint multiplier)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Double_Multiplier_Long_THEN_ReturnProduct(double multiplicand, long multiplier)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Double_Multiplier_UnsignedLong_THEN_ReturnProduct(double multiplicand, ulong multiplier)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Double_Multiplier_Double_THEN_ReturnProduct(double multiplicand, double multiplier)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Double_Multiplier_Decimal_THEN_ReturnProduct(double multiplicand, string multiplierString)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Multiplying_WHILE_Multiplicand_Double_Multiplier_Float_THEN_ReturnProduct(double multiplicand, float multiplier)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
