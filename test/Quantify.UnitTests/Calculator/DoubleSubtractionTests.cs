...
{
    [TestClass]
    public class DoubleSubtractionTests
    {
        [DataTestMethod]
        ...
        public void WHEN_Subtracting_WHILE_Subtrahend_Short_THEN_ReturnDifference(double minuend, string subtrahendString)
        {
            // Arrange
        ...
        [DataRow(double.MinValue, "9")]
        [DataRow(double.MinValue, "0")]
        public void WHEN_Subtracting_WHILE_Subtrahend_UnsignedShort_THEN_ReturnDifference(double minuend, string subtrahendString)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Subtracting_WHILE_Subtrahend_Integer_THEN_ReturnDifference(double minuend, int subtrahend)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Subtracting_WHILE_Subtrahend_UnsignedInteger_THEN_ReturnDifference(double minuend, uint subtrahend)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Subtracting_WHILE_Subtrahend_Long_THEN_ReturnDifference(double minuend, long subtrahend)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Subtracting_WHILE_Subtrahend_UnsignedLong_THEN_ReturnDifference(double minuend, ulong subtrahend)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Subtracting_WHILE_Subtrahend_Double_THEN_ReturnDifference(double minuend, double subtrahend)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Subtracting_WHILE_Subtrahend_Decimal_THEN_ReturnDifference(double minuend, string subtrahendString)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Subtracting_WHILE_Subtrahend_Float_THEN_ReturnDifference(double minuend, float subtrahend)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
