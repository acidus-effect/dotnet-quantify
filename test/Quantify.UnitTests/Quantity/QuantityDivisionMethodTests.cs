...
namespace Quantify.UnitTests.Quantity
{
    ...
    public class QuantityDivisionMethodTests
    {
        ...
        [TestMethod]
        public void WHEN_Dividing_WHILE_Input_Short_THEN_ReturnNewQuantityWithQuotient()
        {
            // Arrange
        ...
        [TestMethod]
        public void WHEN_Dividing_WHILE_Input_UnsignedShort_THEN_ReturnNewQuantityWithQuotient()
        {
            // Arrange
            var quantityUnit = "TheUnit";
            const double quantityValue = 42.548;
        ...
        [TestMethod]
        public void WHEN_Dividing_WHILE_Input_Integer_THEN_ReturnNewQuantityWithQuotient()
        {
            // Arrange
            var quantityUnit = "TheUnit";
        ...
        [TestMethod]
        public void WHEN_Dividing_WHILE_Input_UnsignedInteger_THEN_ReturnNewQuantityWithQuotient()
        {
            // Arrange
            var quantityUnit = "TheUnit";
            const double quantityValue = 42.547;
        ...
        [TestMethod]
        public void WHEN_Dividing_WHILE_Input_Long_THEN_ReturnNewQuantityWithQuotient()
        {
            // Arrange
            var quantityUnit = "TheUnit";
            const double quantityValue = 42.547;
        ...
        [TestMethod]
        public void WHEN_Dividing_WHILE_Input_UnsignedLong_THEN_ReturnNewQuantityWithQuotient()
        {
            // Arrange
            var quantityUnit = "TheUnit";
            const double quantityValue = 42.547;
        ...
        [TestMethod]
        public void WHEN_Dividing_WHILE_Input_Double_THEN_ReturnNewQuantityWithQuotient()
        {
            // Arrange
            var quantityUnit = "TheUnit";
        ...
        [TestMethod]
        public void WHEN_Dividing_WHILE_Input_Decimal_THEN_ReturnNewQuantityWithQuotient()
        {
            // Arrange
            var quantityUnit = "TheUnit";
            const double quantityValue = 254.478952;
        ...
        [TestMethod]
        public void WHEN_Dividing_WHILE_Input_Float_THEN_ReturnNewQuantityWithQuotient()
        {
            // Arrange
            var quantityUnit = "TheUnit";
            const double quantityValue = 254.478952;
