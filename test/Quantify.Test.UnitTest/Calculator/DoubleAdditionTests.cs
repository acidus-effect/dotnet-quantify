...
namespace Quantify.Test.UnitTest.Calculator
{
    ...
    public class DoubleAdditionTests
    {
        ...
        public void WHEN_Adding_WHILE_SecondTerm_Short_THEN_ReturnSum(double term1, string term2String)
        {
            // Arrange
        ...
        [DataRow(double.MinValue, "9")]
        [DataRow(double.MinValue, "0")]
        public void WHEN_Adding_WHILE_SecondTerm_UnsignedShort_THEN_ReturnSum(double term1, string term2String)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Adding_WHILE_SecondTerm_Integer_THEN_ReturnSum(double term1, int term2)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Adding_WHILE_SecondTerm_UnsignedInteger_THEN_ReturnSum(double term1, uint term2)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Adding_WHILE_SecondTerm_Long_THEN_ReturnSum(double term1, long term2)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Adding_WHILE_SecondTerm_UnsignedLong_THEN_ReturnSum(double term1, ulong term2)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Adding_WHILE_SecondTerm_Double_THEN_ReturnSum(double term1, double term2)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Adding_WHILE_SecondTerm_Decimal_THEN_ReturnSum(double term1, string term2String)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Adding_WHILE_SecondTerm_Float_THEN_ReturnSum(double term1, float term2)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
