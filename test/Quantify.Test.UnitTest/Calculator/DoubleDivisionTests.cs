...
namespace Quantify.Test.UnitTest.Calculator
{
    ...
    public class DoubleDivisionTests
    {
        ...
        public void WHEN_Dividing_WHILE_Divisor_Short_THEN_ReturnQuotient(double dividend, string divisorString)
        {
            // Arrange
        ...
        [DataRow(double.MinValue, "9")]
        [DataRow(double.MinValue, "0")]
        public void WHEN_Dividing_WHILE_Divisor_UnsignedShort_THEN_ReturnQuotient(double dividend, string divisorString)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Dividing_WHILE_Divisor_Integer_THEN_ReturnQuotient(double dividend, int divisor)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Dividing_WHILE_Divisor_UnsignedInteger_THEN_ReturnQuotient(double dividend, uint divisor)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Dividing_WHILE_Divisor_Long_THEN_ReturnQuotient(double dividend, long divisor)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Dividing_WHILE_Divisor_UnsignedLong_THEN_ReturnQuotient(double dividend, ulong divisor)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Dividing_WHILE_Divisor_Double_THEN_ReturnQuotient(double dividend, double divisor)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Dividing_WHILE_Divisor_Decimal_THEN_ReturnQuotient(double dividend, string divisorString)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
        ...
        public void WHEN_Dividing_WHILE_Divisor_Float_THEN_ReturnQuotient(double dividend, float divisor)
        {
            // Arrange
            var valueCalculator = new DoubleValueCalculator();
